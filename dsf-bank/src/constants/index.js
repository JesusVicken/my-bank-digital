...
export const experience = [
  {
    title: '10M',
    subtitle:
      'De usuários satisfeitos que confiam no JESUS como seu banco digital de escolha.',
    color: 'blue',
  },
  {
    title: '6 +',
...
export const rewards = {
  title: 'JESUS Rewards - O Programa de Pontos JESUS Bank',
  list: [
    {
      title: 'Acumule pontos e troque por vantagens',
      subtitle:
        'Com o JESUS Rewards você acumule pontos a cada real gasto, podendo trocá-los por passagens aéreas e vantagens exclusivas em nossa loja virtual.',
    },
    {
      title: 'Como funciona',
      subtitle:
        'Você acumula pontos a cada transação realizada com seu cartão de crédito. Além disso, quanto mais você usar os serviços do JESUS Bank, mais pontos acumula. É simples assim!',
    },
  ],
};
  ...
  list: [
    {
      ...
      role: 'Advogada',
      comment:
        'Adorei a praticidade do aplicativo do JESUS Bank. Tudo o que eu preciso está ali na tela do meu celular, sem complicação.',
    },
    {
      avatar: joao,
      name: 'João Santos',
      role: 'Empresário',
      comment:
        'O programa de pontos do JESUS Bank é incrível! Com os pontos que acumulo nas minhas transações, posso fazer compras em lojas parceiras. É uma ótima maneira de economizar!',
    },
    {
      avatar: maria,
      name: 'Maria Ferreira',
      role: 'Estudante',
      comment:
        'Estava procurando por um banco digital seguro e confiável e encontrei o JESUS Bank. Amei a facilidade de abrir uma conta e agora faço todas as minhas transações pelo aplicativo.',
    },
    {
      avatar: carlos,
      name: 'Carlos Gomes',
      ...
      comment:
        'Eu estava cansado de ter que ir até o banco toda semana para resolver minhas pendências. Com o JESUS Bank, agora consigo fazer tudo pelo celular, de forma prática e segura.',
    },
  ],
};
